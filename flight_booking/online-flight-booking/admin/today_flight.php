          ...
          $date=date('Y-m-d');
            ...
            while($a=mysqli_fetch_array($q)){
                ...
                <td><a href="user_flight.php?fd=<?php echo $a[id]?>" id="<?php echo $a[id]?>" class="fa fa-user text-success"  > User</a>
                    <a href="javascript:void(0)" id="<?php echo $a[id].'@@@'.$a[time1].'@@@'.$a[time2]?>" class="fa fa-edit text-primary" data-toggle="modal" data-target="#myModal" onclick="issue(this.id)"  > Issue</a>
