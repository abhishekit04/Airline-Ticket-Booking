            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                            <div class="header-title  h3 col-10"><?php echo $_REQUEST['action']==''?'Departed':$_REQUEST['action'] ?> Flight List:</div>
        ...
        <table class="table pagi_table table-bordered table-striped table-condensed table-hover table-sm "id="" >
         ...
         <tbody class="text-dark">
            ...
            while($a=mysqli_fetch_array($q)){
                ...
                <td><a href="user_flight.php?fd=<?php echo $a[id]?>" id="<?php echo $a[id]?>" class="fa fa-user text-success"  > User</a>
                    <a href="back.php?actionajax=flight_arived&id=<?php echo $a[id]?>" id="" class="fa fa-edit text-primary" > Arived </a>
                    <a href="back.php?actionajax=delete_flight_details&id=<?php echo $a[id]?>" id="" class="fa fa-trash text-danger" onclick='return confirm("Are you sure ?");'> Deleted </a>
            </td>
        </tr>
                <?php
            }
